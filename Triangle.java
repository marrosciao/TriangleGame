...
public class Triangle {
	...
	public int openMoves(){
		...
		/*
		for(int i = 0; i <15; i++){
			if(slotSet[i].isEmpty()){
				for(int j = 0; j<15; j++){
					if(slotSet[j].isFull()){
						if((slotSet[j].getX() == slotSet[i].getX()-1) && (slotSet[j].getY() == slotSet[i].getY()-1)){
							for(int k = 0; k<15; k++){
								if(slotSet[k].isFull()){
									if((slotSet[k].getX() == slotSet[j].getX()-1) && (slotSet[k].getY() == slotSet[j].getY()-1)){
										result++;
									}
								}
							}
						...
						if((slotSet[j].getX() == slotSet[i].getX()-1) && (slotSet[j].getY() == slotSet[i].getY())){
							for(int k = 0; k<15; k++){
								if(slotSet[k].isFull()){
									if((slotSet[k].getX() == slotSet[j].getX()-1) && (slotSet[k].getY() == slotSet[j].getY())){
										result++;
									}
								}
							}
						...
						if((slotSet[j].getX() == slotSet[i].getX()) && (slotSet[j].getY() == slotSet[i].getY()+1)){
							for(int k = 0; k<15; k++){
								if(slotSet[k].isFull()){
									if((slotSet[k].getX() == slotSet[j].getX()) && (slotSet[k].getY() == slotSet[j].getY()+1)){
										result++;
									}
								}
							}
